...
JAZZER_JUNIT_JAR_PATH=$PWD/$(bazel cquery --output=files //deploy:jazzer-junit)
JAZZER_JUNIT_DOCS_PATH=$PWD/$(bazel cquery --output=files //deploy:jazzer-junit-docs)
JAZZER_JUNIT_SOURCES_PATH=$PWD/$(bazel cquery --output=files //deploy:jazzer-junit-sources)
