...
public final class ClassLoaderFuzzer {
  public static class ExposingClassLoader extends ClassLoader {
    public Class<?> define(byte[] bytes) {
      //            return super.defineClass(null, bytes, -10, bytes.length + 10);
      return super.defineClass("com.example.Example", bytes, 0, bytes.length);
    }
  }
