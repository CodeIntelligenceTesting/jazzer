...
def jazzer_dependencies():
    ...
    maybe(
        ...
        sha256 = "0c5a5b55cf63e146903fcf018c5d33a32144971f87089fcfcb38f244addf68fc",
        url = "https://github.com/fmeum/rules_jni/releases/download/v0.2.0/rules_jni-v0.2.0.tar.gz",
    )
