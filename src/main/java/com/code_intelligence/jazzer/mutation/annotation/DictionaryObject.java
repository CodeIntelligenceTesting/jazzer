 ...
 *
 * <pre>{@code
 * public class MyDictionaryProvider implements DictionaryProvider {
 *   @Override
 *   public Stream<?> value() {
 ...
 *
 *   @DictionaryObject(MyDictionaryProvider.class)
 *   @FuzzTest
...
public @interface DictionaryObject {
  Class<? extends DictionaryProvider> value();

  /*
   * This {@code DictionaryObject} will be used with probability {@code 1/p} by the mutator responsible for
