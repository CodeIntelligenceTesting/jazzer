...
public class PerExecutionLifecycleTest {
  private static final String ENGINE = "engine:junit-jupiter";
  private static final String CLAZZ = "class:com.example.PerExecutionLifecycleFuzzTest";
  ...
  private EngineExecutionResults executeTests() {
    return EngineTestKit.engine("junit-jupiter")
        .selectors(selectClass("com.example.PerExecutionLifecycleFuzzTest"))
